...
System.register(['aurelia-framework', './cytoscapeHelper'], function (_export, _context) {
  "use strict";

  var inject, CytoscapeHelper, _dec, _class, App;
  ...
  return {
    ...
    }, function (_cytoscapeHelper) {
      CytoscapeHelper = _cytoscapeHelper.CytoscapeHelper;
    }],
    execute: function () {
      _export('App', App = (_dec = inject(CytoscapeHelper), _dec(_class = function () {
        App.prototype.showConfig = function showConfig() {
          this.showTools = true;
        };

        App.prototype.setImage = function setImage() {
          this.cytoscape.setImage();
        };

        App.prototype.generateImage = function generateImage() {
        ...
        App.prototype.generate = function generate() {
